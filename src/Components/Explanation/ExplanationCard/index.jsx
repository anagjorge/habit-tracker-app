  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.explanationContainer}>
        ...
        />
        <Text style={styles.description}>
          <Text style={styles.money}>Financeiro: </Text> Hábitos para ajudar
          você com o controle financeiro
        </Text>
      </View>
      ...
      <View style={styles.explanationContainer}>
        ...
        />
        <Text style={styles.description}>
          <Text style={styles.body}>Corpo: </Text> Hábitos para te ajudar a ser
          mais saudável
        </Text>
      </View>
